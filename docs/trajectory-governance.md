...
| Confidence calibration | Benchmark-side reducer + report committed; verdict gate defined; real benchmark data now exists (2026-06-11 run) but judge enrichment has not been run on it — calibration verdict pending (T3 #1) |
